  ...
  data.forEach((item, index) => {
    ...
    row.innerHTML = `
            ...
            <td  style="text-align: center;">
                <button class="edit-button" data-edit-id="${
                  item._id
                }" style="background-color: #B99B6B;"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></button>
                <button class="delete-button" data-id="${
                  item._id
                }" style="background-color: #AA5656;"><i class="fa-solid fa-trash"></i></button>
            </td>
        `;
